   ...
   //RECIBIMIENTO DE DATOS DE REGISTRO DE USUARIO
    ...
    //Se reciben los datos mandados a través del formulario:
        ...
        $estado_usuario_c = $_GET['estado'];
                ...
                $sql = "UPDATE usuarios set habilitarUsuario= 1 WHERE idUsuario= $id_usuario_c";
                ...
                if($rta){
                    echo "<script>alert('Usuario: $nombre_usuario_c habilitado!'); window.location='../vistasadmin/lista_de_usuarios_admin.php'</script>";
